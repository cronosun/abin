...
use abin::{AnyBin, AnyRc, Bin, NoVecCapShrink, RcBin};
use bin_gen::BinGen;
...
fn basic_rc_non_sync() {
    for index in SAFE_SIZE..1024 {
        ...
        extracting_returns_same_memory_location::<RcBin, Bin>(&bin_gen);
        into_vec_with_more_than_one_ref_count::<RcBin, Bin>(&bin_gen);
    }
}
