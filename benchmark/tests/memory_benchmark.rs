...
use abin_benchmark::{
    benchmark_test_set, run_benchmark_single_threaded, BenchStr, SStrBenchStr, StdLibArcStrOnly,
    StdLibOptimized, StdLibStringOnly,
};
...
fn test_abin_is_better_or_equal_everywhere() {
    compare::<StdLibArcStrOnly, SStrBenchStr>();
    compare::<StdLibStringOnly, SStrBenchStr>();
    compare::<StdLibOptimized, SStrBenchStr>();
}
